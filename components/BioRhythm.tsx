...
const BioRhythm: React.FC<BioRhythmProps> = ({ birthDate }) => {
  ...
  return (
    <div className="relative group cursor-help flex items-center justify-center">
      {/* Tooltip */}
      <div className="absolute top-full mt-2 left-0 w-40 bg-slate-900 text-white text-xs rounded-lg py-3 px-4 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-[100] shadow-xl border border-slate-700">
