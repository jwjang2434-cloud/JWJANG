// 통근버스 노선 데이터
// 생성 날짜: 2025. 11. 27. 오전 11:50:44

import { ReferenceDoc, Notice, BusRoute, Station } from './types';
    ...
    "stations": [
      {
        "name": "문현동 전철역123",
        "time": "07:14",
        "locationDesc": "홍익빌레트 2,3 사이(문현역1번 3번 출구 사이)",
        "stationImage": "/images/fuji_flag.png",
      },
      {
        "name": "부산진역",
        "time": "07:18",
        "locationDesc": "부산진역7번 출구",
        "stationImage": "/images/fuji_flag.png",
      },
      {
        "name": "부산역",
        "time": "07:25",
        "locationDesc": "부산역 1번 출구",
        "stationImage": "/images/fuji_flag.png",
      },
      {
        "name": "동대신 시장",
        "time": "07:28",
        "locationDesc": "마을버스 정류장(미진축산 앞)",
        "stationImage": "/images/fuji_flag.png",
      },
      {
        "name": "괴정역",
        "time": "07:38",
        "locationDesc": "괴정역1번 출구",
        "stationImage": "/images/fuji_flag.png",
      },
      {
        "name": "당리",
        "time": "07:43",
        "locationDesc": "파리바게트 건너편",
        "stationImage": "/images/fuji_flag.png",
      },
      {
        "name": "하단",
        "time": "07:50",
        "locationDesc": "자이언트타이어 하단점 앞",
        "stationImage": "/images/fuji_flag.png",
      },
      {
        "name": "신평역",
        "time": "07:53",
        "locationDesc": "신평역 4번 출구 횡단보도 앞",
        "stationImage": "/images/fuji_flag.png",
      },
      {
        "name": "포트빌",
        "time": "08:20",
        "locationDesc": "포트빌 맞은 편 횡단보도 앞",
        "stationImage": "/images/fuji_flag.png",
      },
      {
        "name": "회사도착",
    ...
    "stations": [
      {
        "name": "시청역",
        "time": "07:05",
        "locationDesc": "7번 출구 횡단보도 건너서 시청 건물 옆 (투썸플레이스 맞은편)"
      },
      {
        "name": "연산역",
        "time": "07:08",
        "locationDesc": "16번 출구 지나서 LG유플러스 연산동 연산로타리점 앞(연산동sk뷰 2단지 아파트 건물)"
      },
      {
        "name": "동래역",
        "time": "07:13",
        "locationDesc": "4호선 동래역 5번 출구(세연정 앞)"
      },
      {
        "name": "덕천역",
        "time": "07:33",
        "locationDesc": "3호선 덕천역 12번 출구"
      },
      {
        "name": "구포역",
        "time": "07:36",
        "locationDesc": "구포역 1번 출구"
      },
      {
        "name": "불암역",
        "time": "07:46",
        "locationDesc": "1번 출구 앞 버스 정류장"
      },
      {
        "name": "회사 도착",
        "time": "08:30",
...
export const NOTICE_LIST: Notice[] = [
  {
    id: '1',
    title: '2025년 연말정산 안내',
    content: '2025년도 연말정산 일정을 안내드립니다. 자세한 내용은 첨부파일을 확인해주세요.',
    date: '2025-01-15',
    type: 'MUST_READ',
    author: '인사팀'
  },
  {
    id: '2',
    title: '사내 보안 점검 실시',
    content: '이번 주 금요일 사내 보안 점검이 있을 예정입니다. 퇴근 시 책상 정리를 부탁드립니다.',
    date: '2025-02-10',
    type: 'NORMAL',
    author: '총무팀'
  },
  {
    id: '3',
    title: '신규 입사자 소개',
    content: '개발팀에 새로운 동료가 합류했습니다. 환영해주세요!',
    date: '2025-03-02',
    type: 'NORMAL',
    author: '인사팀'
  }
...
export const LATEST_NOTICE: Notice = NOTICE_LIST[0];
